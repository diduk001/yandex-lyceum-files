                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                              <div class="carousel-inner">
                                <div class="carousel-item active">
                                  <img class="d-block w-100" src="{url_for("static", filename="img/carousel/1.jpg")}">
                                </div>
                                <div class="carousel-item">
                                  <img class="d-block w-100" src="{url_for("static", filename="img/carousel/2.jpg")}">
                                </div>
                                <div class="carousel-item">
                                  <img class="d-block w-100" src="{url_for("static", filename="img/carousel/3.jpeg")}">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{url_for("static", filename="img/carousel/4.jpg")}">
                                </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="{url_for("static", filename="img/carousel/5.jpg")}" >
                                </div>
                              </div>
